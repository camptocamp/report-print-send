...
class TestPingen(HttpCase):
		...
		return json.dumps({
			  "data": {
				...
				"attributes": {
				  ...
				  "url": "https:\/\/36f4-2a02-1210-3497-c400-296e-3b7-6940-e38b.ngrok-free.app\/\/pingen\/letter_issues",
				  "created_at": "2023-05-19T09:35:01+0200"
				},
				"relationships": {
				  "organisation": {
					"links": {
					  "related": "https:\/\/identity-staging.pingen.com\/organisations\/4c08c24e-65f8-47cf-b280-518ee76e3437"
					},
					"data": {
					  "type": "organisations",
				  ...
				  "letter": {
					"links": {
					  "related": "https:\/\/identity-staging.pingen.com\/organisations\/4c08c24e-65f8-47cf-b280-518ee76e3437\/letters\/ddd105d8-42f6-4357-a103-9b2449bbd8e2"
					},
					"data": {
					  "type": "letters",
					  "id": uuid,
			  ...
			  "included": [{
				...
				"links": {
				  "self": "https:\/\/identity-staging.pingen.com\/organisations\/4c08c24e-65f8-47cf-b280-518ee76e3437"
				}
			  }, {
				"type": "letters",
				...
				"links": {
				  "self": "https:\/\/identity-staging.pingen.com\/organisations\/4c08c24e-65f8-47cf-b280-518ee76e3437\/letters\/ddd105d8-42f6-4357-a103-9b2449bbd8e2"
				}
			  }, {
				"type": "letters_events",
				"id": "a9612d08-81c0-4259-8b0a-648c85377f71",
	...
	def test_pingen_push_document(self):
		...
		with patch('odoo.addons.pingen.controllers.main.PingenController._get_request_content') as mocked_function, MockRequest(self.env) as mock_request:
			mocked_function.return_value = self.get_request_json(pingen_document.pingen_uuid)
